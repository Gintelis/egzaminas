...
if (isset($_GET['del_id'])){
    ...
    $del_sql = "DELETE FROM uzd1Tasks WHERE id ='$_GET[del_id]'";
...
?>    
       ...
       <div class="container">
           ...
           $sql = "SELECT uzd1Tasks.*, uzd1_statuses.name FROM uzd1Tasks, uzd1_statuses WHERE uzd1Tasks.status_id = uzd1_statuses.ID and user_id = ".$_SESSION['user_id']."";      
