<?php
    ...
    $sql = "INSERT INTO uzd1Tasks (task_name, task_description, user_id ,status_id)  VALUES  ('$name', '$description',".$_SESSION['user_id'].", '$status')";                   $result = mysqli_query($conn, $sql);
        if($result){           
  ...
  $status = mysqli_query($conn,"SELECT * FROM uzd1_statuses");
?>
<!DOCTYPE html>
